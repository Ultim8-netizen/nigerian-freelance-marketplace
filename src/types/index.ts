 ...
 * This file provides developer-friendly aliases only.
 *
 * NOTE: When you regenerate database.types.ts via the Supabase CLI, this file
 * does NOT need to be changed — it derives everything from the generated types.
 */
...
// Profile is imported from extended.types to get the properly narrowed user_type
// ('client' | 'freelancer' | 'both' | 'admin') and other literal unions.
// All other types come directly from the auto-generated database.types.
export type { Profile } from './extended.types';
...
// ============================================================================
// CUSTOM FORM & UTILITY TYPES  (not auto-generated, defined here manually)
// ============================================================================
...
// ============================================================================
// EXTENDED TYPES  (relations + computed fields, for component consumption)
// ============================================================================
