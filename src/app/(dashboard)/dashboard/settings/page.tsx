                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-2">
                      ...
                      <Toggle
                        ...
                        onChange={() =>
                          toggleSetting('promotionalEmails')
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-2">
                      ...
                      <Toggle
                        ...
                        onChange={() =>
                          toggleSetting('withdrawalApproval')
                        }
                      />
                    </div>
              ...
              <>
                ...
                >
                  <div className="space-y-2">
                    {['public', 'verified_only', 'private'].map(
                      (option) => (
                        <label
                          key={option}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-2">
                      ...
                      <Toggle
                        ...
                        onChange={() =>
                          toggleSetting('allowDirectMessages')
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400"
                      >
                        <option value="NGN">
                          Nigerian Naira (₦)
                        </option>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-2">
                      ...
                      <Toggle
                        ...
                        onChange={() =>
                          toggleSetting('animationsEnabled')
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between p-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-2">
                      ...
                      <Toggle
                        ...
                        onChange={() =>
                          toggleSetting('autoAcceptTopMatches')
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between p-2">
                      ...
                      <Toggle
                        ...
                        onChange={() =>
                          toggleSetting('autoRejectLowOffers')
                        }
                      />
                    </div>
                    <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
