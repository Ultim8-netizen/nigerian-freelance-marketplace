// src/app/f9-control/layout.tsx
//
// FIX: Analytics nav link was a DormantNavItem with tooltip "Coming soon".
//   The analytics page at src/app/f9-control/analytics/page.tsx is fully
//   implemented and auth-gated. The dormant item was stale from before the
//   page was built. Replaced with a real NavLink.
